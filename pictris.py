...
def make_contender_line(i):
    ...
    label_result_name.setMinimumSize(QSize(45, 15))
    label_result_name.setMaximumSize(QSize(45, 15))
    label_result_rounds = QtWidgets.QLabel()
    label_result_rounds.setMaximumSize(QSize(45, 15))
    label_result_rounds.setMinimumSize(QSize(45, 15))
    label_result_percent = QtWidgets.QLabel()
    label_result_percent.setMaximumSize(QSize(45, 15))
    label_result_percent.setMinimumSize(QSize(45, 15))
    label_result_points = QtWidgets.QLabel()
    label_result_points.setMaximumSize(QSize(45, 15))
    label_result_points.setMinimumSize(QSize(45, 15))
